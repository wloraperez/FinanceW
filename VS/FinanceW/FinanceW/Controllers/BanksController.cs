...
namespace FinanceW.Controllers
{
    public class BanksController : Controller
    {
        ...
        public BanksController(FinanceWContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var bank = await _context.Banks
                .SingleOrDefaultAsync(m => m.BankId == id);
            if (bank == null)
            {
                return NotFound();
            }
        ...
        public async Task<IActionResult> Create([Bind("BankId,Description,Country,StatusBank")] Bank bank)
        {
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            var bank = await _context.Banks.SingleOrDefaultAsync(m => m.BankId == id);
            if (bank == null)
            {
                return NotFound();
            }
